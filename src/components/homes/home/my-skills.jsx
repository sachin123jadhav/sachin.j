...
import TopShape from "./../../../../public/assets/img/about/offter-item-shape-top.png";
import BottomShape from "./../../../../public/assets/img/about/offter-item-shape-bottom.png";

function MySkills() {
  const [key, setKey] = useState("Technologies");

  // Skills list with SVGs
  const techSkills = [
    {
      name: "React",
      svg: (
  ...
  return (
    <section className="my-skills p-relative pt-50 pb-50">
      <div className="container">
        <div className="row justify-content-center text-center mb-25">
          <div className="col-md-12 col-lg-8">
            <h5 className="tp-section-subtitle-4 pb-10">My Skills</h5>
          ...
          <div className="col-lg-12">
            ...
            >
                    ...
                    >
                      <div className="offer__item">
                        <div className="shape-top">
                          <Image src={TopShape} alt={skill.name} />
                        </div>
                        <div className="shape-bottom">
                          <Image src={BottomShape} alt={skill.name} />
                        </div>
                        <div className="offer__icon">{skill.svg}</div>
                        <h4 className="mt-20">{skill.name}</h4>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <Tab eventKey="DesignTools" title="Design Tools">
                Tab content for Design Tools
              </Tab>

              <Tab eventKey="FrontEndFrameworks" title="Front-End Frameworks">
                Tab content for Front-End Frameworks
              </Tab>

              <Tab eventKey="CMS" title="CMS & E-Commerce">
                Tab content for CMS
              </Tab>
            </Tabs>
          </div>
